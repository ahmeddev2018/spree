        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down">{{ Auth::user()->firstname. " ". Auth::user()->lastname }}</i>
                </a>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{route('posts.create')}}">Create News</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="{{route('roles.index')}}"><i class="fa fa-bar-chart-o fa-fw"></i> Roles</a>
